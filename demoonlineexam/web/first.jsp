...
out.println("<TD bgColor=#e56e94 vAlign=top align=middle width='60%'>Hi "+sname+"<FONT color='white' size=2 face=Tahoma> (student id="+sid+")</FONT></td>");
Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
Connection c=DriverManager.getConnection("jdbc:odbc:mydsn");
Statement s=c.createStatement();
String tbl=sname+"qtable";
String tbl2=sname+"edetails";
